...
mixin _$CreateCategoryState {
 ...
 SubmissionStatus get status; CreateCategoryResponse? get data; Failure? get failure;
/// Create a copy of CreateCategoryState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CreateCategoryStateCopyWith<CreateCategoryState> get copyWith => _$CreateCategoryStateCopyWithImpl<CreateCategoryState>(this as CreateCategoryState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateCategoryState&&(identical(other.status, status) || other.status == status)&&(identical(other.data, data) || other.data == data)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@override
String toString() {
  return 'CreateCategoryState(status: $status, data: $data, failure: $failure)';
}
...
/// @nodoc
abstract mixin class $CreateCategoryStateCopyWith<$Res>  {
  factory $CreateCategoryStateCopyWith(CreateCategoryState value, $Res Function(CreateCategoryState) _then) = _$CreateCategoryStateCopyWithImpl;
@useResult
$Res call({
 SubmissionStatus status, CreateCategoryResponse? data, Failure? failure
});


$CreateCategoryResponseCopyWith<$Res>? get data;

}
/// @nodoc
class _$CreateCategoryStateCopyWithImpl<$Res>
    implements $CreateCategoryStateCopyWith<$Res> {
  _$CreateCategoryStateCopyWithImpl(this._self, this._then);

  final CreateCategoryState _self;
...
as CreateCategoryResponse?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
/// Create a copy of CreateCategoryState
...
$CreateCategoryResponseCopyWith<$Res>? get data {
  ...
  return $CreateCategoryResponseCopyWith<$Res>(_self.data!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  CreateCategoryResponse? data,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  CreateCategoryResponse? data,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  CreateCategoryResponse? data,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure);case _:
  return null;
...
class _CreateTeacherState implements CreateCategoryState {
...
@override final  CreateCategoryResponse? data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $CreateCategoryStateCopyWith<$Res> {
...
@override $CreateCategoryResponseCopyWith<$Res>? get data;
