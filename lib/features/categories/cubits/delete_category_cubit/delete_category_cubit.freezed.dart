...
mixin _$DeleteCategoryState {
 ...
 SubmissionStatus get status; DeleteCategoryResponse? get data; Failure? get failure;
/// Create a copy of DeleteCategoryState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DeleteCategoryStateCopyWith<DeleteCategoryState> get copyWith => _$DeleteCategoryStateCopyWithImpl<DeleteCategoryState>(this as DeleteCategoryState, _$identity);
...
@override
String toString() {
  return 'DeleteCategoryState(status: $status, data: $data, failure: $failure)';
}
...
/// @nodoc
abstract mixin class $DeleteCategoryStateCopyWith<$Res>  {
  factory $DeleteCategoryStateCopyWith(DeleteCategoryState value, $Res Function(DeleteCategoryState) _then) = _$DeleteCategoryStateCopyWithImpl;
@useResult
$Res call({
 SubmissionStatus status, DeleteCategoryResponse? data, Failure? failure
});
...
/// @nodoc
class _$DeleteCategoryStateCopyWithImpl<$Res>
    implements $DeleteCategoryStateCopyWith<$Res> {
  _$DeleteCategoryStateCopyWithImpl(this._self, this._then);

  final DeleteCategoryState _self;
  final $Res Function(DeleteCategoryState) _then;
...
as DeleteCategoryResponse?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
/// Create a copy of DeleteCategoryState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  DeleteCategoryResponse? data,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  DeleteCategoryResponse? data,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  DeleteCategoryResponse? data,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure);case _:
  return null;
...
class _CreateTeacherState implements DeleteCategoryState {
...
@override final  DeleteCategoryResponse? data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $DeleteCategoryStateCopyWith<$Res> {
