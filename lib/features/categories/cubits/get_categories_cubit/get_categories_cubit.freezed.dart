...
mixin _$GetCategoriesState {
 ...
 SubmissionStatus get status; List<CategoryModel>? get data; Failure? get failure;
/// Create a copy of GetCategoriesState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GetCategoriesStateCopyWith<GetCategoriesState> get copyWith => _$GetCategoriesStateCopyWithImpl<GetCategoriesState>(this as GetCategoriesState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetCategoriesState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@override
String toString() {
  return 'GetCategoriesState(status: $status, data: $data, failure: $failure)';
}
...
/// @nodoc
abstract mixin class $GetCategoriesStateCopyWith<$Res>  {
  factory $GetCategoriesStateCopyWith(GetCategoriesState value, $Res Function(GetCategoriesState) _then) = _$GetCategoriesStateCopyWithImpl;
@useResult
$Res call({
 SubmissionStatus status, List<CategoryModel>? data, Failure? failure
});
...
/// @nodoc
class _$GetCategoriesStateCopyWithImpl<$Res>
    implements $GetCategoriesStateCopyWith<$Res> {
  _$GetCategoriesStateCopyWithImpl(this._self, this._then);

  final GetCategoriesState _self;
  final $Res Function(GetCategoriesState) _then;
...
as List<CategoryModel>?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
...
extension GetCategoriesStatePatterns on GetCategoriesState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  List<CategoryModel>? data,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  List<CategoryModel>? data,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  List<CategoryModel>? data,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure);case _:
  return null;
...
class _CreateTeacherState implements GetCategoriesState {
  const _CreateTeacherState({this.status = SubmissionStatus.initial, final  List<CategoryModel>? data, this.failure}): _data = data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $GetCategoriesStateCopyWith<$Res> {
