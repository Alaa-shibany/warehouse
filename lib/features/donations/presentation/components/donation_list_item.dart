...
import 'package:warehouse/features/donations/presentation/components/show_single_donation_dialog.dart';
...
class _DonationListItemState extends State<DonationListItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        showDonationDetailsDialog(context, widget.donationItem.id);
      },
      child: MouseRegion(
